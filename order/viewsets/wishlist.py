...
class ProductSerializer_WishlistProductsView(serializers.ModelSerializer):
    ...
    class Meta:
        model = Product
        fields =  ['id','has_variations','is_stock','total_sale','name','title','slug','public_id','description','price','category','quantity','brand','discount','featured_image','product_type','average_rating','total_rating']
